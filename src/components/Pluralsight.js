...
const PluralSight = ({onChange, onLinkSubmit, loading, errors}) => {
    ...
    return ( 
        <Form className="col-sm-6 offset-sm-3 text-center" onSubmit= {onLinkSubmit} >
            ...
            <Form.Group controlId="formPluralLink" className=" justify-content-center">
                <Form.Label>Download PluralSight files on the go!!</Form.Label>
